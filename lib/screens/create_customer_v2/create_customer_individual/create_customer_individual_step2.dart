        ...
        return Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              if (controller.customerType == CustomerType.company)
                SiteInfo(
                  isSwitched: true,
              ...
              if (controller.customerType == CustomerType.individual)
                SiteInfo(
                  isSwitched: false,
                  activeColor: Colors.green,
                  value: !controller.isSiteAddSameInfo,
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      if (!controller.isSiteAddSameInfo == isSwitched)
                        CommonText(
                          'No',
                          fontColor: Colors.grey[700],
                          fontWeight: FontWeight.bold,
              ...
              CommonContainer(
                ...
                child: AnimatedSwitcher(
                  ...
                  child: controller.isSiteAddSameInfo == isSwitched
                      ? CommonContainer(
                          child: Column(
                            children: <Widget>[
                              CommonInput(
